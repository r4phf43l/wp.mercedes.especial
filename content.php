...
<?php if ( is_user_logged_in() ) { get_template_part('sidebar','cliente'); } ?>
</div>
    <!--<div class="full-content entry-container<?=$pos_text?>">-->
    <div class="entry-container<?=$pos_text?>">
        <div class='entry-header'>
                <h1 class='entry-title'><?php get_the_title($pageparent); the_title(); ?></h1>
        </div>
