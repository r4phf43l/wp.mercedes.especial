...
class category_featured_images
{
	...
	function admin_print_scripts()
	{
		...
		//wp_register_script( 'cfi-scripts', TEMPLATEPATH . '/plugins/category-featured-images.js', array( 'jquery' ) );
		wp_register_script( 'cfi-scripts', get_template_directory_uri () . '/plugins/category-featured-images.js', array( 'jquery' ) );
	...
	function admin_print_styles()
	{
		...
		//wp_register_style( 'cfi-styles', TEMPLATEPATH . '/plugins/cfi-styles.css' );
		wp_register_style( 'cfi-styles', get_template_directory_uri () . '/plugins/cfi-styles.css' );
		...
		<table class="form-table">
			<tr class="form-field">
				...
				<td>
					...
					<input id="cfi-remove-image" class="button" type="button" value="Remover imagem" />
					<input id="cfi-change-image" class="button" type="button" value="Alterar imagem" />
					<div id="cfi-thumbnail"><?php if( !empty( $image ) ) echo wp_get_attachment_image( $image ); ?></div>
					<p class="description">Defina uma imagem para todas as imagens dessa categoria sem uma imagem de destaque.</p>
				</td>
			</tr>
		</table>
	<?php
