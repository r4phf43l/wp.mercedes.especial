...
class LinkableTitleHtmlAndPhpWidget extends WP_Widget {
    ...
    function LinkableTitleHtmlAndPhpWidget() {
        $widget_ops = array('classname' => 'widget_text', 'description' => __('Texto normal ou HTML, este widget permite adicionar links nos cabeçalhos dos textos (Plugin Mercedes Comunimax by PepLamb/RafaAntonio)'));
        $control_ops = array('width' => 400, 'height' => 350);
        $this->WP_Widget('LinkableTitleHtmlAndPhpWidget', __('Texto com Link'), $widget_ops, $control_ops);
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo $this->get_field_id('titleUrl'); ?>"><?php _e('Link:'); ?></label>
       ...
       <p><label for="<?php echo $this->get_field_id('titleColor'); ?>"><?php _e('Title Color:'); ?></label>
        ...
        <label for="<?php echo $this->get_field_id('removeTextContentDivTag'); ?>"><?php _e('Remove Text Content Div Tag'); ?></label></p></span>
        ...
        <label for="<?php echo $this->get_field_id('newWindow'); ?>"><?php _e('Abrir link em nova janela'); ?></label></p>
        
        <p><label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('Texto'); ?></label><!-- , Html, Javascript, Flash and/or Php: -->
        <textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>"><?php echo $text; ?></textarea>

        <p><input id="<?php echo $this->get_field_id('filter'); ?>" name="<?php echo $this->get_field_name('filter'); ?>" type="checkbox" <?php checked(isset($instance['filter']) ? $instance['filter'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('filter'); ?>"><?php _e('Adicionar parágrafos automaticamente.'); ?></label></p>
